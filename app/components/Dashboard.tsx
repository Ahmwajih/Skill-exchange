        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="text-center">
            ...
            <div className="mt-4 flex justify-center items-center">
              <div
                className={"flex items-center px-4 py-2  text-gray "}>
                                <span className=" mr-2">{profileData.followers.length}</span>
                <span className=" mr-2">{profileData.followers.length >= 2 ? 'followers': "follower" }</span>
...
//   followUser,
// } from "@/lib/features/dashboard/userSlice";
// import { addSkillToUser, deleteSkill, fetchSkillById } from "@/lib/features/skills/skillsSlice";
// import ReactCountryFlag from "react-country-flag";
// import { useRouter } from "next/navigation";
// import AddSkillModal from "./AddSkillModal";
// import EditSkillModal from "./EditSkillModal"; // Import the EditSkillModal component
// import Link from "next/link";
// import Image from "next/image";
// import LinkedIn from "@/app/public/LinkedIn.png";
// import github from "@/app/public/github.jpg";
// import avatar from "@/app/public/avatar.jpg";
// import { FaPen, FaTrash } from "react-icons/fa"; // Import pen and trash icons
...
//   const [isVacationMode, setIsVacationMode] = useState(false);
//   const [showAddSkillModal, setShowAddSkillModal] = useState(false);
//   const [showEditSkillModal, setShowEditSkillModal] = useState(false); // State for showing edit skill modal
//   const [selectedSkill, setSelectedSkill] = useState(null); // State for selected skill to edit
//   const [following, setFollowing] = useState(false);
...
//       // Refresh the profile data after deleting the skill
