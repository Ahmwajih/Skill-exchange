...
export default function SignIn() {
  ...
  return (
    ...
    <form className="flex flex-col mt-12 ml-8 max-w-full w-[358px] max-md:mt-10" onSubmit={handleSignIn}>
      ...
      <button type="button" className="flex overflow-hidden gap-2 justify-center items-center px-5 py-3 mt-4 max-w-full text-base font-medium bg-white rounded-md border border-gray-100 border-solid shadow-sm min-h-[46px] text-slate-500 w-[358px]" onClick={() => handleProviderSignIn('google')}>
      ...
      <button type="button" className="flex overflow-hidden gap-2 justify-center items-center px-5 py-2.5 mt-4 max-w-full text-base font-medium bg-white rounded-md border border-gray-100 border-solid shadow-sm min-h-[46px] text-slate-500 w-[358px]" onClick={() => handleProviderSignIn('github')}>
